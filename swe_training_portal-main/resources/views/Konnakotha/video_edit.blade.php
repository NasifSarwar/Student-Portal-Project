              ...
              {!! Form::open(['url' => URL::to('/video/'.$show->id), 'method'=>"put",  'id'=>'myform', 'enctype'=>'multipart/form-data']) !!}
                                @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="vedio_caption_english" placeholder="Example:Opening Programme" value="{{$show->video_caption_english}}" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="vedio_caption_bangla" placeholder="উদাহরণ:উদ্বোধন অনুষ্ঠান " value="{{$show->video_caption_bangla}}" class="form-control" />
