...
<a class="image-link" target="_blank" href="{{asset('/images/' .$banner->image) }}"> 
<img src="{{ asset('/images/' .$banner->image) }}" alt="" height="75px" width="80px">
</a>
</center></td></b></center></td>    
...
<td><center><a class="btn btn-xs btn-warning" target="_blank" href="/" role="button">ভিউ</a></center></td>
