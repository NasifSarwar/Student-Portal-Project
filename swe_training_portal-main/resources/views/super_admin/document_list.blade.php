...
<th><center><b>ডকুমেন্টের টাইটেল(ইংলিশ)</b></center></th>

<th><center><b>ডকুমেন্টের টাইটেল(বাংলা)</b></center></th>


<th><center><b>ডকুমেন্ট ফাইল</b></center></th>
...
{!! Form::open(['url' => URL::to('/document/'.$doc->id),"method"=>"DELETE"]) !!}
...
<td><center><a class="btn btn-xs btn-warning" target="_blank" href="/document_bn" role="button">ভিউ</a></center></td>

<td>
<a href="{{ URL::to('/document/'.$doc->id.'/edit') }}" class="btn btn-primary mb-1">এডিট</a>
