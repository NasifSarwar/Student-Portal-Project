...
{!! Form::open(['url' => URL::to('/create_special_training/'.$event->id),"method"=>"DELETE"]) !!}
...
<td><center><a class="btn btn-xs btn-warning" target="_blank" href="/training_category/{{$event->category_id}}" role="button">View</a></center></td>

<td>
<a href="{{ URL::to('/create_special_training/'.$event->id.'/edit') }}" class="btn btn-primary mb-1">Edit</a>
