              ...
              <form action="/menu" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="menu_name" placeholder="Example:About Us" value="{{old('menu_name')}}" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="menu_name_bangla" placeholder="উদাহরণ:আমাদের সম্পর্কে" value="{{old('menu_name_bangla')}}" class="form-control" />
                                            @if ($errors->first('menu_name_bangla'))<div class="alert alert-danger">{!! $errors->first('menu_name_bangla') !!}</div> @endif
                                            
                                        </div>

                                        <div class="form-group">
                                            <label><b>মেন্যুর লিংক(ইংলিশের জন্য):</b></label>
                                            <input type="text"  name="link" placeholder="উদাহরণ:/about_us" value="{{old('link')}}" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="link_bangla" placeholder="উদাহরণ:/about_us" value="{{old('link_bangla')}}" class="form-control" />
